...
public class GeoKretDataSource {
	...
	private final static String TABLE = GeoKretySQLiteHelper.TABLE_INVENTORY;
	private final static String PK_COLUMN = GeoKretySQLiteHelper.COLUMN_TRACKING_CODE;

	private static final String FETCH_ALL = "SELECT " //
			+ PK_COLUMN + ", " //
			+ GeoKretySQLiteHelper.COLUMN_USER_ID + ", " //
			+ GeoKretySQLiteHelper.COLUMN_NAME + ", " //
			+ GeoKretySQLiteHelper.COLUMN_STICKY //
			+ " FROM " //
