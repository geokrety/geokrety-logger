...
public class GeoKretLog {
    private static final String[] LOG_TYPE_MAP = {
            "0", "1", "3", "5", "2"
    };
    ...
    public GeoKretLog(final Cursor cursor, final int i, final boolean secidInQuery,
            final boolean joinsInQuery) {
        this( //
                cursor.getInt(i + 0), //
                cursor.getInt(i + 1), //
                cursor.getInt(i + 2), //
    ...
    public String formatProblem(final Context context) {
        try {
